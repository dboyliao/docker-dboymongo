...
if mongo_logpath:
    cmd = "echo 'mongod --auth --port {port} --dbpath {dbpath} --logpath {logpath}' >> /home/scripts/mongod.sh"
    ...
    cmd = "echo 'mongod --auth --port {port} --dbpath {dbpath}' >> /home/scripts/mongod.sh"
